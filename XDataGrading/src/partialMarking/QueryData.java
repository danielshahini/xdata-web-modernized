...
public class QueryData {
	...
	public void Initialize() throws CloneNotSupportedException{
		...
		ArrayList<Conjunct> conjuncts = this.QueryBlock.getConjuncts();

		for(Conjunct con: conjuncts){
		...
		Vector<Conjunct> conjunctList = this.Parser.getConjuncts();
		for(Conjunct c : conjunctList){
		...
		getFromTables(this.Parser.queryAliases, tables);
