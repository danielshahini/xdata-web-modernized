...
import partialMarking.FromClauseElement;
import util.Graph;
...
public class QueryParser implements Serializable{
	...
	public FromClauseElement queryAliases;
	...
	public void setQueryAliases(FromClauseElement queryAliases) {
	...
	// @junaid modified
	public FromClauseElement getQueryAliases() {
		return queryAliases;
	}
...
//					ProcessSelectClause.ProcessSelect(plainSelect, debug, this);
				...
				if(((Select) stmt).getSelectBody() instanceof PlainSelect 
					...
					//partialMarking.ProcessSelectClause.ProcessSelect((PlainSelect)((Select) stmt).getSelectBody(), debug, this);
				}
