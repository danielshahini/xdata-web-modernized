				...
				<legend> Application Info</legend>
					<%
						...
						try(Connection dbcon = (new DatabaseConnection()).dbConnection()){
				 		...
				 		String instructions = (new CommonFunctions()).getTesterAssignmentInstructions(courseID, assignID);
				 		/*if(rs_lti.next()){
						...
						instructions = (new CommonFunctions()).getAssignmentInstructions(courseID, assignID, url);						
								...
								//String starting=formatter.format(start);
									...
									if(!noASsign){
										...
										output += "<ul>"
												...
												+ "<li><a id='viewQuestions' href=\"ListOfTesterQuestions.jsp?AssignmentID="
												+ Integer.parseInt(request.getParameter("assignmentId"))
												+"\" target = \"rightPage\"> View/Edit Questions</a>"
												+ " </li></ul>";
