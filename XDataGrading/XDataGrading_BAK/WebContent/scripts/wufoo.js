...
function toggleInstructorAnswer(id){
	$(id).toggle();

	if($(id).parent().children()[0].innerHTML=="View Instructor Answer"){
		$(id).parent().children()[0].innerHTML="Hide Instructor Answer";
	}
	else{
		$(id).parent().children()[0].innerHTML="View Instructor Answer";
	}
}
