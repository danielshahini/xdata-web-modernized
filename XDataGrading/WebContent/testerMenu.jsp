	...
	<!-- 	<lh class="header"> 
		...
		<%//} %> -->
		  <br> 
			...
			<li class="header">Application
			<ul>
			<li><a class="header" target="rightPage" href="NewApplicationCreation.jsp">Create New</a></li>
			<li><a class="header" target="rightPage" href="ListAllApplications.jsp">View All</a></li>
