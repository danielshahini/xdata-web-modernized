...
public class GetNodeQueryStructure {
	...
	public static Vector<Node> flattenNode(com.xdata.legacy.parsing.QueryStructure qStructure, Node node) {
	...
	public static Vector<Vector<Node>> flattenCNF(com.xdata.legacy.parsing.QueryStructure qStructure, Node node) {
