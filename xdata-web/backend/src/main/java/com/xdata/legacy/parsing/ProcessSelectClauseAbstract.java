...
public abstract class ProcessSelectClauseAbstract {
	...
	/**	 method copied and adapted by mathew for query structure from com.xdata.legacy.parsing.Util.java
	 * 
	 * @param qStruct
	 */
	...
	public abstract void processFromListSubJoin(Select subJoin, Vector<FromClauseElement> visitedFromListElements, Vector<Node> joinConditions,
	...
	public abstract void processFromListParenthesedSelect(ParenthesedSelect ParenthesedSelect, QueryStructure subQueryParser,QueryStructure parentQueryParser) throws Exception;
	public abstract void processWhereParenthesedSelect(ParenthesedSelect ParenthesedSelect, QueryStructure subQueryParser,QueryStructure parentQueryParser) throws Exception;
