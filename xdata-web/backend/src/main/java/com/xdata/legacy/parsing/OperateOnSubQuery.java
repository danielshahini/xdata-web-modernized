...
public class OperateOnSubQuery {
	...
	public static FromListElement OperateOnSubquery(FromSubquery subquery,Vector<Node> allConds, JoinTreeNode jtn,boolean fromSubquery, boolean whereSubquery, com.xdata.legacy.parsing.QueryParser qParser) throws Exception {
		try{
		...
		if(subquery.getSubquery() instanceof IntersectOrExceptNode ){
			...
			com.xdata.legacy.parsing.QueryParser leftQueryParser = new com.xdata.legacy.parsing.QueryParser(qParser.getTableMap());
			com.xdata.legacy.parsing.QueryParser rightQuryParser = new com.xdata.legacy.parsing.QueryParser(qParser.getTableMap());
