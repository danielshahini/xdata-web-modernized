...
public class OperateOnSubQueryJSQL {
	...
	public static FromListElement OperateOnSubquery(ParenthesedSelect subquery,Vector<Node> allConds, JoinTreeNode jtn,boolean fromSubquery, boolean whereSubquery, parsing.QueryParser qParser,AppTest_Parameters dbApparameters) throws Exception {
		try{
		String aliasName = "";
