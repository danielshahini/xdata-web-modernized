...
public class AggregateFunction implements java.io.Serializable{
	...
	Node aggExp;
	Column aggCol;
	Vector<Column> aggColumns = new Vector<Column>();
	boolean isDistinct;
	String func;
	String aggAliasName;
	...
	public Vector<Column> getAggColumns(){
		return this.aggColumns;
	}
	public void setAggCols(Vector<Column> columns){
		this.aggColumns = columns;
	}

	public void setAggCol(Column aggCol) {
		this.aggCol = aggCol;
		this.aggColumns.add(aggCol);
	}
